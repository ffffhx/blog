...
```text
https://124-221-36-36.anyip.dev:8443/token-board
```
...
- Homepage URL: `https://124-221-36-36.anyip.dev:8443/token-board`
- Authorization callback URL: `https://124-221-36-36.anyip.dev:8443/token-board/api/auth/github/callback`
- Device Flow: enabled
